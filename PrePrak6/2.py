...
background_image = Image.open('direktory/argus-light-of-dawn-skin-mobile-legends-uhdpaper.com-4K-6.2869.jpg')
overlay_image = Image.open('direktory/908481.512.webp')
